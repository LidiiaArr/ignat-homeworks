...
function HW2() {
    const [affairs, setAffairs] = useState<Array<AffairType>>(defaultAffairs) // изначально дефолтный массив потом его изменяем
    const [filter, setFilter] = useState<FilterType>('all')//Храним фильтр

    const filteredAffairs = filterAffairs(affairs, filter) //Хранение отфильрованного массива
